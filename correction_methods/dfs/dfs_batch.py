...
matrdy=np.genfromtxt("/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko/batch_rm_dfs_sextupole/rm_nosextupole/response_mat_mad_dy_nosextupole.out", delimiter=",", dtype='float')
...
kicker_strb=kicker_str_1[0]/2.0
