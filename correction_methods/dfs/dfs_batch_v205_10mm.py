...
matrdy=np.genfromtxt("/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko_205/response_matrix/no_sextupole/build_response_matrix_no_sextupole_10mm/resp_mat_dy_nosextupole_v205_10mm.out", delimiter=",", dtype='float')
...
kicker_strb=kicker_str_1[0]/1.0
