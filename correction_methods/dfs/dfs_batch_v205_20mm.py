...
matrdy=np.genfromtxt("/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko_205/response_matrix/no_sextupole/build_response_matrix_no_sextupole_20mm/resp_mat_dy_nosextupole_v205_20mm.out", delimiter=",", dtype='float')
