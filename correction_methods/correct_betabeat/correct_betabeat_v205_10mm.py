...
bare=TwissTable("/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko_205/response_matrix/beta_beat/response_matrix_v205_10mm/twiss_bare_bpm.twiss")
muy0=bare.get_muy()
mux0=bare.get_mux()
dx0=bare.get_dx()
...
#-------------------------- Solve the system ------------------------------------------
path="/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko_205/response_matrix/beta_beat/response_matrix_v205_10mm/"
#file_resp="respmat_phaseadv.txt"
file_resp="respmat_phaseadv_v205_10mm.txt"
...
k1_str=x[0]/1.0+str_temp

ku_name=["KQU"+str(i) for i in np.arange(1,1185)]
k1name=ku_name
