...
bare=TwissTable("/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko_205/response_matrix/beta_beat/response_matrix_v205_2mm/twiss_bare_bpm.twiss")
muy0=bare.get_muy()
mux0=bare.get_mux()
dx0=bare.get_dx()
...
#-------------------------- Solve the system ------------------------------------------
path="/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko_205/response_matrix/beta_beat/response_matrix_v205_2mm/"
