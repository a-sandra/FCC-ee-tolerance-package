...
difference=np.array([tab.F1001R,tab.F1001I])*w2
addit=np.array([tab.F1010R,tab.F1010I])*w2
optics=np.genfromtxt("twiss_coupling.twiss",dtype=None,skip_header=47)
dy_tab=optics['f12']*w1
...
print "sol sys"
matrdt=np.genfromtxt("/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko/batch_rm_rdt/1176_skews/rdt_dy_respmat_sextupole_skewonallsext.txt", delimiter=",", dtype='float')
print "load matrix"
