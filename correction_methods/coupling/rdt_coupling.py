...
print "sol sys"
matrdt=np.genfromtxt("/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko/batch_rm_rdt/1176_skews/respmat_rdt_skewonallsext.txt", delimiter=",", dtype='float')
print "load matrix"
...
skew_str=resulting_solution[0]/2.0+str_temp # I add then to my solution.
