...
print "solve system"
matrdt=np.genfromtxt("/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko_205/response_matrix/coupling/build_matrix_rdt_v205_2mm/rdt_arc_sy_ip_response_matrix_v205_2mm.txt", delimiter=",", dtype='float')
