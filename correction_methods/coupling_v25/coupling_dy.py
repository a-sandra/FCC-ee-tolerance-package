...
print "sol sys"
matrdt=np.genfromtxt("/afs/cern.ch/user/s/saumon/FCCee/correction_scheme/correction_scheme_ko_205/response_matrix/coupling/build_matrix_rdt_v205/rdt_dy_response_skewallsext_v205.txt", delimiter=",", dtype='float')
print "load matrix"
